...
def check_collision_with_walls():
    ...
    # detect collision with bottom wall.In this case, user failed to hit the ball, thus he loses. The game resets.
    if ball.ycor() < -280:
        ball.reset()
...
#Ball and Paddle movement management
def check_collision_with_paddle():
    ...
    # check if ball's distance(from its middle) to paddle(from its middle) is less than width of paddle and ball is below a certain 
...
#Ball and bricks collision management
